...
class SkillDetailScreen extends StatefulWidget {
  ...
  SkillDetailScreen({Key? key, required this.swap, this.highlightedAssetId})
    : super(key: key);
                      ...
                      if (isMentor)
                        GestureDetector(
                          onTap: () => Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (_) =>
                                  CreateSessionScreen(swap: widget.swap),
                            ),
                          ),
                          child: Container(
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text(
                '${(widget.swap.progress * 100).toInt()}%',
                style: TextStyle(
                  color: Theme.of(context).colorScheme.primary,
                  fontSize: 18,
                  fontWeight: FontWeight.bold,
          ...
          Row(
            ...
            children: [
              _StatMini(
                label: 'completed'.tr(),
                value: widget.swap.completedSessions.toString(),
              ),
              Container(
                width: 1,
                height: 30,
              ...
              _StatMini(
                label: 'total'.tr(),
                value: widget.swap.totalSessions.toString(),
              ),
              Container(
                width: 1,
                height: 30,
