...
class _MyTeachingScreenState extends State<MyTeachingScreen> {
  ...
  Widget _buildEmptyState() {
    return Center(
      child: Text('no_teaching_swaps'.tr(), style: TextStyle(color: Theme.of(context).colorScheme.onSurfaceVariant)),
    );
  }
          ...
          Row(
            ...
            children: [
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('XP / Skills Taught: ${data.skillsTeachingCount}',
